...
public class VentaDAO {
    private static final String PROCEDURE_INSERT_VENTA = "{CALL CRUD_ventas_PKG.INSERTAR_VENTA_SP(?, ?, ?, ?)}";
    ...
    private static final String PROCEDURE_LIST_VENTA = "{CALL CRUD_ventas_PKG.LISTAR_VENTA_SP(?)}";
    ...
    public int obtenerVentasPorSucursal(int idSucursal) {
     ...
     public String listarVentasPorClienteSucursal() {
        String listaVentas = "";
        try (Connection connection = Conexion.obtenerConexion();
             CallableStatement statement = connection.prepareCall("{ ? = call ListarVentasPorClienteSucursal_FN }")) {
    ...
    private static final String PROCEDURE_GET_MAX_VENTA_ID = "{CALL CRUD_ventas_PKG.VENTA_ID_SP(?)}";
    public int IdVenta() {
    int id = 0;
    try (Connection connection = Conexion.obtenerConexion();
