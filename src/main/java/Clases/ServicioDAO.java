...
public class ServicioDAO {
    private static final String PROCEDURE_INSERT_SERVICIO = "{CALL CRUD_servicio_PKG.INSERTAR_SERVICIO_SP(?, ?, ?, ?)}";
    ...
    private static final String PROCEDURE_LIST_SERVICIO = "{CALL CRUD_servicio_PKG.LISTAR_SERVICIO_SP(?)}";
    ...
    private static final String PROCEDURE_DELETE_SERVICIO = "{CALL CRUD_servicio_PKG.Eliminar_Servicio_SP(?)}";
    ...
    private static final String PROCEDURE_UPDATE_SERVICIO = "{CALL CRUD_servicio_PKG.Actualizar_Servicio_SP(?, ?, ?,?,?)}";
